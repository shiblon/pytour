...
function CodeCtrl($scope, $http, $location, $timeout) {
  ...
  // If PyPyJS loaded, we can use that.
  (function(document, window, undefined) {
    ...
    if (typeof window.__BRYTHON__ === "undefined") {
      throw new Error("Client-side Brython implementation not available");
    }
    console.log("Using client-side Brython implementation");
    $scope.runCode = makeRunOnBrython(__BRYTHON__);
  }(document, window))
